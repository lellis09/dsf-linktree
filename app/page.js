      ...
      <section className='flex flex-col  items-center mt-10 lg:mt-16 pt-12 w-full md:w-1/2'>
        <div className='rounded-full bg-teal-500 w-32 h-32 lg:w-48 lg:h-48 border-2 overflow-hidden relative'>
          ...
          <div className='flex flex-col gap-5'>
            ...
            <button className='text-navy text-lg uppercase rounded-2xl transition-all duration-500 bg-gradient-to-br to-hotpink via-myTeal from-lightgreen bg-size-200 bg-pos-0 w-full lg:w-auto h-12 flex justify-center items-center hover:bg-pos-100 hover:text-white'type='button' >
              Twitter
              </button>
           </a>
