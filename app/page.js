...
export default function Home() {
  return (
    <main className="flex h-screen flex-col items-center bg-gradient-to-b from-myindigo to bg-navy">
      ...
      <section className='flex flex-col border-[1.75px] border-lightgreen items-center mt-16 pt-12 w-full max-w-[42rem] lg:w-1/2'>
        <div className='rounded-full bg-teal-500 w-20 h-20 lg:w-44 lg:h-44 border-2 border-lightgreen overflow-hidden relative'>
          ...
          <div className='flex flex-col'>
            ...
            <button className='rounded-2xl border-[1.75px] border-lightgreen w-[24rem] lg:w-[42rem] h-12 flex justify-center items-center'type='button' >
